...
namespace SimpleWebServer.Extensions
{
    ...
    public static class extensions
    {
        ...
        /// <param name="charset">HTTP Charset, UTF-8 by default</param>
        /// <returns>True if the response creation is successful; otherwise, false.</returns>
        public static async Task<bool> CreateHTMLResponseAsync(this HttpListenerContext ctx, string HTMLContent, int statusCode = 200, Dictionary<string, string> additionalHeaders = null, string charset = "utf-8")
        {
            return await ctx.CreateResponseAsync(Encoding.UTF8.GetBytes(HTMLContent), statusCode, $"text/html; charset={charset};", additionalHeaders);
        }
        ...
        /// <param name="charset">HTTP Charset, UTF-8 by default</param>
        /// <returns>True if the response creation is successful; otherwise, false.</returns>
        public static async Task<bool> CreateCSSResponseAsync(this HttpListenerContext ctx, string CSSContent, int statusCode = 200, Dictionary<string, string> additionalHeaders = null, string charset = "utf-8")
        {
            return await ctx.CreateResponseAsync(Encoding.UTF8.GetBytes(CSSContent), statusCode, $"text/css; charset={charset};", additionalHeaders);
        }
        ...
        /// <param name="charset">HTTP Charset, UTF-8 by default</param>
        /// <returns>True if the response creation is successful; otherwise, false.</returns>
        public static async Task<bool> CreateJavaScriptResponseAsync(this HttpListenerContext ctx, string javaScriptContent, int statusCode = 200, Dictionary<string, string> additionalHeaders = null, string charset = "utf-8")
        {
            return await ctx.CreateResponseAsync(Encoding.UTF8.GetBytes(javaScriptContent), statusCode, $"application/javascript; charset={charset};", additionalHeaders);
        }
        ...
        /// <param name="charset">HTTP Charset, UTF-8 by default</param>
        /// <returns>True if the response creation is successful; otherwise, false.</returns>
        public static async Task<bool> CreateStringResponseAsync(this HttpListenerContext ctx, string content, int statusCode = 200, Dictionary<string, string> additionalHeaders = null, string charset = "utf-8")
        {
            return await ctx.CreateResponseAsync(Encoding.UTF8.GetBytes(content), statusCode, $"text/plain; charset={charset};", additionalHeaders);
        }
        ...
        /// <param name="additionalHeaders">Additional HTTP headers</param>
        /// <returns>True if the response creation is successful; otherwise, false.</returns>
        public static async Task<bool> CreateFileResponseAsync(this HttpListenerContext ctx, string filePath, string customFileName = null, int statusCode = 200, Dictionary<string, string> additionalHeaders = null)
        {
            try
            {
                if (!File.Exists(filePath)) return false;
                ...
                using (FileStream fs = File.OpenRead(filePath))
                {
                    ...
                    {
                        await ctx.Response.OutputStream.WriteAsync(buffer, 0, bytesRead);
                    }
                }
        ...
        /// <param name="additionalHeaders">Additional HTTP headers</param>
        /// <returns>True if the response creation is successful; otherwise, false.</returns>
        public static async Task<bool> CreateResponseAsync(this HttpListenerContext ctx, byte[] buffer, int statusCode = 200, string contentTypeHeader = null, Dictionary<string, string> additionalHeaders = null)
        {
            try
            {
                HttpListenerResponse response = ctx.Response;
